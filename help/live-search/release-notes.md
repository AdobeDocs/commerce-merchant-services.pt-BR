...
Estas notas de versão descrevem as versões mais recentes da [!DNL Live Search] e incluem:
...
* ![Bug](../assets/bug.svg) - A classificação por &quot;Recomendado para você&quot; só é compatível com os widgets do Live Search. Ela não é compatível com a funcionalidade de pesquisa padrão LUMA e PWA.
* ![Bug](../assets/bug.svg) - As facetas de atributos de preço personalizados não são renderizadas corretamente na LUMA, mas a API as filtra corretamente.
