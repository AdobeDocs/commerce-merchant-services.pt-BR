...
- Você [configurado](connect-data.md) o [!DNL Data Connection] extensão
- Você [confirmado](connect-data.md#confirm-that-event-data-is-collected) que seus dados de evento do Commerce estão chegando à Experience Platform
...
1. Na navegação à direita, configure seu evento da seguinte maneira:
   ...
   1. Selecionar **[!UICONTROL Fields]** e no **[!UICONTROL Fields]** que for exibida, selecione os campos úteis para esse evento. Por exemplo, selecione todos os campos sob a **[!UICONTROL Product list items]**, **[!UICONTROL Commerce]**, **[!UICONTROL eventType]**, e **[!UICONTROL Web]**.
