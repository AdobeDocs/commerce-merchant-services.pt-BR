...
![[!DNL Composable Catalog Data Model] Mapeamento de Canal, Política e Escopo](assets/ccdm-scope-map.png)
...
| **Novos escopos de produtos de catálogo**: canal, política e escopo são novos escopos de produtos introduzidos pelo CCDM. Esses escopos de produto substituem os escopos de site, loja e loja na camada de serviços da loja. [Saiba mais](#product-context-management). | <ul><li>Com os novos escopos, a CCDM desbloqueia a capacidade de dimensionar para casos de uso de várias regiões geográficas, unidades de vários negócios, várias marcas e vários idiomas com facilidade usando um único catálogo básico.</li><li>Elimine a redundância de dados no gerenciamento de catálogos.</li></ul> |
...
## Que tipo de comerciante se beneficia mais da CCDM?

A tabela a seguir destaca os desafios comuns que os comerciantes encontram e como o CCDM os aborda.
