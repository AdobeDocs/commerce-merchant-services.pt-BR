...
1. Use os seletores de alternância para ativar ou desativar [!DNL PayPal smart button] recursos de exibição:
   ...
   - **[!UICONTROL Show Apple Pay button]**
      ...
      >[!NOTE]
      >
      > O Apple Pay é ativado por padrão para o modo sandbox, mas você também pode [deve ter uma conta de desenvolvedor do Apple](test-validate.md#test-in-sandbox-environment) (completo com informações falsas de cartão de crédito e faturamento) para testá-lo. Quando estiver pronto para usar o Apple Pay no modo de produção, após concluir qualquer [teste e validação](test-validate.md), entre em contato com as vendas para habilitá-lo para sua(s) loja(s) em tempo real.
