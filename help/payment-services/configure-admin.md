---
title: Configurar no Administrador
description: Após a instalação, você pode configurar [!DNL Payment Services] em Admin.
role: Admin, User
level: Intermediate
...
### Configurar botões inteligentes do PayPal
